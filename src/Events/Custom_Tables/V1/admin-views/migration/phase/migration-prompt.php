 ...
 */
?>
<div class="tec-ct1-upgrade--migration-prompt">
	...
	<?php if ( ! $preview_unsupported ) : ?>
		<div class="tec-ct1-upgrade__row">
			<?php $this->template( 'migration/partials/report' ); ?>
		</div>
	<?php endif; ?>
		...
		<div class="content-container">
			<?php if ( ! $report->has_errors ) : ?>
				<button
					...
					type="button"
				>
					<?php echo esc_html( $text->get( 'start-migration-button' ) ); ?>
				</button>
			<?php endif ?>
			<?php if ( ! $preview_unsupported ) : ?>
				<i>
